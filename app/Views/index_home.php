            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                        ...
                        <H class="d-flex">
                            <a href="/profile" class="nav-link "> <?= $b ?></a>
                        </H>
                        <H class="d-flex">
                    ...
                    <div class="card-body py-5 px-md-5">
                        ...
                        <div class="row d-flex justify-content-center">
                            <div class="col-lg-20">
                                        ...
                                        <div class="col-6 col-sm-4 mb-5">
                                            <div class="card" style="width: 18rem;">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <a href="/KeranjangController/masukKeranjang/<?= $a['id_item'] ?>/<?= $c ?>" class="btn btn-primary">Checkout</a>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } ?>
                                ...
                                <!-- Submit button -->
                                <a type="button" href="/keranjang" class="btn btn-primary btn-block mb-4">
                                    Keranjang
                                </a>
